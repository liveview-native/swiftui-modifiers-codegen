...
extension AttributedTextFormattingDefinitionModifier: RuntimeViewModifier {
    ...
    public init(syntax: FunctionCallExprSyntax) throws {
        ...
        case 1:
            ...
            } else if let value0 = S.Type(syntax: (syntax.arguments.count > 0 ? syntax.arguments[0].expression : nil)!) {
                self = .attributedTextFormattingDefinitionWithType(value0)
            } else if let value0 = Swift.KeyPath<Foundation.AttributeScopes, S.Type>(syntax: (syntax.arguments.count > 0 ? syntax.arguments[0].expression : nil)!) {
